 ...
 * This script tests the Web3 and Web3-Onboard integration
 * Run with: node test-web3-integration.js
 */

const Web3 = require('web3');
const Onboard = require('@web3-onboard/core');
const injectedModule = require('@web3-onboard/injected-wallets');
