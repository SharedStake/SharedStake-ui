...
This document captures the module boundaries, trust assumptions, storage design, and threat model for the SharedStake V2 modular staking core. It accompanies the implementation in `staking-contracts/contracts/v2/modular-staking/`.
