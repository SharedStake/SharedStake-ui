...
contract SharedDeposit is Pausable, ReentrancyGuard {
    ...
    using SafeMath for uint;
     /* ========== STATE VARIABLES ========== */
    //address goerli_medella_beacon_testnet = 0x07b39F4fDE4A38bACe212b546dAc87C58DfE3fDC; //TODO: change
    address public depositContractAddress = 0x07b39F4fDE4A38bACe212b546dAc87C58DfE3fDC;
    ...
    constructor(uint256 _numValidators, uint256 _adminFee, uint256 _refundDeadline, address _BETHTokenAddress) public {
        ...
        buffer = 1e18; // roughly equal to 1eth. 

        BETHToken = IBETH(BETHTokenAddress);

        adminFeeTotal = 0;
        curValidatorShares = 0;
        validatorsCreated = 0;
    ...
    function workable() external view returns (bool) {
        ...
        bool validatorLimitReached = (curValidatorShares >= this.maxValidatorShares());
    ...
    function remainingSpaceInEpoch() external view returns (uint256) {
        ...
        uint remainingShares = (this.maxValidatorShares()).sub(curValidatorShares);
    ...
    */
    ...
    function depositToEth2(bytes calldata pubkey,
        ...
        bytes32 deposit_data_root) external onlyOwner nonReentrant {
            uint256 amount = 32 ether;
            require(curValidatorShares >= this.maxValidatorShares(), "Eth2Staker:depositToEth2: Not at validator limit");
            require(address(this).balance >= amount, "Eth2Staker:depositToEth2: Not enough balance"); //need at least 32 ETH
            require(this.workable() == true, "Eth2Staker:depositToEth2: Not workable"); // redundant check to enforce consistent gaurds
    ...
    // Recover ownership of token supply and mint
